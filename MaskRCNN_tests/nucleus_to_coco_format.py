...
inpath = path+"stage1_train/"  # the train folder download from kaggle
outpath = path+"mask/"  # the folder putting all nuclei image
...
# In[ ]:
with open(path+"nucleus_cocoformat.json", "w") as f:
