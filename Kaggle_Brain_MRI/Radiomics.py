...
def radiomics_click(path, pth_name):
    radiomics(path, pth_name)
def radiomics(path, pth_name):
#%% path
    """
    pth_name="radiomics3dCNN_2012_resnet_more_layers"
...
#%% Extract clinical data and outcome
    ...
    val_loader = DataLoader(val_set, batch_size = 3,pin_memory=True,shuffle=False,num_workers=0)
